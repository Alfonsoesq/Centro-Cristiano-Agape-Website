  ...
  return (
    <>
      ...
      <main className="max-w-4xl mx-auto p-6">
        ...
        <section aria-labelledby="service-times" className="mb-6">
          <h2 id="service-times" className="text-xl font-semibold mb-2">Horario de Servicios</h2>
        ...
        <section aria-labelledby="location-title" className="mb-6">
          <h2 id="location-title" className="text-xl font-semibold mb-2">Nuestra Ubicación</h2>
        ...
        {/* Social Media Links */}
        <section aria-labelledby="social-media" className="mb-6">
          <h2 id="social-media" className="text-xl font-semibold mb-4">Síguenos en Redes Sociales</h2>
          <div className="flex space-x-8 text-3xl text-gray-700">
        ...
        <div className="text-center mt-8">
          <a
            href="/contacto"
            className="inline-block bg-green-600 text-white font-semibold px-8 py-3 rounded-md hover:bg-green-700 transition"
          >
            Contáctanos
          </a>
        </div>
