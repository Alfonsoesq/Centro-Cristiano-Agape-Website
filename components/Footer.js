      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <div className="flex space-x-6 text-2xl text-gray-600">
            ...
            <a
              href="https://www.instagram.com/ccagapegdl/?hl=en"
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              href="https://www.youtube.com/@secretosdelreino/featured"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="YouTube"
        ...
        <div>
          ...
          <ul className="mb-6 space-y-2">
            ...
            <li>
              <a href="/visitar" className="hover:underline">
                Planifica tu Visita
              </a>
            </li>
            <li>
            ...
            <li>
              <a href="/sermones" className="hover:underline">
                Sermones
              </a>
            </li>
          </ul>
